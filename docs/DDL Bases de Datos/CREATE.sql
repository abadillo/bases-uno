...
CREATE TABLE PARTICIPANTE(
     ...
     CONSTRAINT PARTICIPANTE_SUBASTA_FK FOREIGN KEY( SUBASTA_id ) REFERENCES SUBASTA( id ) ON DELETE CASCADE
);
...
CREATE TABLE ORG_INV(
     ...
     CONSTRAINT ORG_INV_SUBASTA_FK FOREIGN KEY( SUBASTA_id ) REFERENCES SUBASTA( id )  ON DELETE CASCADE,
...
CREATE TABLE ORG_SUB(
     ...
     CONSTRAINT ORG_SUB_SUBASTA_FK FOREIGN KEY( SUBASTA_id ) REFERENCES SUBASTA( id ) ON DELETE CASCADE
);
...
CREATE TABLE LISTADO(
     ...
     CONSTRAINT LISTADO_SUBASTA_FK FOREIGN KEY( SUBASTA_id ) REFERENCES SUBASTA( id ) ON DELETE CASCADE
);
