...
{
    public partial class menuorganizacion : Form
    {

        public index parent;
        public Button activeButton;

        public menuorganizacion(index parent)
        {
            this.parent = parent;
            ...
            ButtonEnable(buttonListado, new organizacionl(parent));
        }
        ...
        {
            ButtonEnable(buttonRegistro, new organizacionr(parent));
        }
