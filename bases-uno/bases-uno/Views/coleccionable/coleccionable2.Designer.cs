...
namespace bases_uno.Views
{
    partial class coleccionable2
    {
        ...
        private void InitializeComponent()
        {
			...
			this.coleccionableBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.coleccionableDataSet = new bases_uno.Reports.DataSets.ColeccionableDataSet();
			this.coleccionableTableAdapter = new bases_uno.Reports.DataSets.ColeccionableDataSetTableAdapters.coleccionableTableAdapter();
			this.stpanel7.SuspendLayout();
			this.dipanel1.SuspendLayout();
			this.hrpanel.SuspendLayout();
			this.panel2.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.coleccionableBindingSource)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.coleccionableDataSet)).BeginInit();
			this.SuspendLayout();
			// 
			// stpanel7
			// 
			...
			reportDataSource1.Value = this.coleccionableBindingSource;
			this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
			this.reportViewer1.LocalReport.ReportEmbeddedResource = "bases_uno.Reports.ColeccionableReport.rdlc";
			...
			// 
			// coleccionableBindingSource
			// 
			this.coleccionableBindingSource.DataMember = "coleccionable";
			this.coleccionableBindingSource.DataSource = this.coleccionableDataSet;
			// 
			// coleccionableDataSet
			// 
			this.coleccionableDataSet.DataSetName = "ColeccionableDataSet";
			this.coleccionableDataSet.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
			// 
			// coleccionableTableAdapter
			// 
			this.coleccionableTableAdapter.ClearBeforeFill = true;
			// 
			// coleccionable2
			// 
			...
			this.Name = "coleccionable2";
			this.Text = "8 Bit Subastas";
			this.Load += new System.EventHandler(this.coleccionable2_Load);
			...
			((System.ComponentModel.ISupportInitialize)(this.coleccionableBindingSource)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.coleccionableDataSet)).EndInit();
        ...
        private Reports.DataSets.ColeccionableDataSet coleccionableDataSet;
        private System.Windows.Forms.BindingSource coleccionableBindingSource;
        private Reports.DataSets.ColeccionableDataSetTableAdapters.coleccionableTableAdapter coleccionableTableAdapter;
    }
}