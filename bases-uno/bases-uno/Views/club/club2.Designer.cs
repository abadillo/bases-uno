...
namespace bases_uno.Views
{
    partial class club2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.clubBindingSource.DataSource = this.dataSet;
            // 
            // dataSet
            // 
            ...
            reportDataSource1.Value = this.clubBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "bases_uno.Reports.ReportClub.rdlc";
            ...
            this.Load += new System.EventHandler(this.club2_Load);
