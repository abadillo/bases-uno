...
namespace bases_uno.Views
{
    partial class local2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.localTableAdapter = new bases_uno.Reports.DataSets.DataSetTableAdapters.localTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "bases_uno.Reports.ReportLocal.rdlc";
            ...
            this.localBindingSource.DataSource = this.dataSet;
            // 
            // localTableAdapter
            // 
            ...
            this.Load += new System.EventHandler(this.local2_Load);
        ...
        private Reports.DataSets.DataSetTableAdapters.localTableAdapter localTableAdapter;
    }
}